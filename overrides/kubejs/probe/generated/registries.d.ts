...
declare namespace Registry {
    ...
    class Block extends Internal.RegistryEventJS<any> {
        ...
        create(id: string, type: "farmersdelight:pie"): Internal.PieBlockBuilder;
        create(id: string, type: "farmersdelight:feast"): Internal.FeastBlockBuilder;
    ...
    class Item extends Internal.RegistryEventJS<any> {
        ...
        create(id: string, type: "farmersdelight:knife"): Internal.KnifeItemBuilder;
